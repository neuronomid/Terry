...
@overload
def trange(candles: np.ndarray, sequential: Literal[False] = ...) -> float: ...
@overload
def trange(candles: np.ndarray, sequential: Literal[True] = ...) -> np.ndarray: ...
@overload
def trange(candles: np.ndarray, sequential: bool = ...) -> Union[float, np.ndarray]: ...
