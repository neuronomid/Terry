...
@overload
def var(candles: np.ndarray, period: int = ..., nbdev: float = ..., source_type: str = ..., sequential: Literal[False] = ...) -> float: ...
@overload
def var(candles: np.ndarray, period: int = ..., nbdev: float = ..., source_type: str = ..., sequential: Literal[True] = ...) -> np.ndarray: ...
@overload
def var(candles: np.ndarray, period: int = ..., nbdev: float = ..., source_type: str = ..., sequential: bool = ...) -> Union[float, np.ndarray]: ...
