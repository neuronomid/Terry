...
@overload
def ma(candles: np.ndarray, period: int = ..., matype: int = ..., source_type: str = ..., sequential: Literal[False] = ...) -> float: ...
@overload
def ma(candles: np.ndarray, period: int = ..., matype: int = ..., source_type: str = ..., sequential: Literal[True] = ...) -> np.ndarray: ...
@overload
def ma(candles: np.ndarray, period: int = ..., matype: int = ..., source_type: str = ..., sequential: bool = ...) -> Union[float, np.ndarray]: ...
