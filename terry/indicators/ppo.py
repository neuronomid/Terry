...
@overload
def ppo(candles: np.ndarray, fast_period: int = ..., slow_period: int = ..., matype: int = ..., source_type: str = ..., sequential: Literal[False] = ...) -> float: ...
@overload
def ppo(candles: np.ndarray, fast_period: int = ..., slow_period: int = ..., matype: int = ..., source_type: str = ..., sequential: Literal[True] = ...) -> np.ndarray: ...
@overload
def ppo(candles: np.ndarray, fast_period: int = ..., slow_period: int = ..., matype: int = ..., source_type: str = ..., sequential: bool = ...) -> Union[float, np.ndarray]: ...
