...
@overload
def ui(candles: np.ndarray, period: int = ..., scalar: float = ..., source_type: str = ..., sequential: Literal[False] = ...) -> float: ...
@overload
def ui(candles: np.ndarray, period: int = ..., scalar: float = ..., source_type: str = ..., sequential: Literal[True] = ...) -> np.ndarray: ...
@overload
def ui(candles: np.ndarray, period: int = ..., scalar: float = ..., source_type: str = ..., sequential: bool = ...) -> Union[float, np.ndarray]: ...
